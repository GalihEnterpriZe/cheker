  ...
  def main(self):
    ...
    if os.path.exists(
      ...
      if len(
        ...
        exit(
          '[!] Empas tidak ada atau tidak valid pastikan berisi email:pass atau email|pass'
        )
      print(
      ...
      ask = input(
        '[?] Apakah Anda ingin menggunakan proxy?(\033[92mDisarankan\033[0m) [Y/t]: '
      )
      if ask.lower(
      ).strip(
      ) == 'y':
